...
const config: SplashCursorProps = {
  SIM_RESOLUTION: 128,
  DYE_RESOLUTION: 1440,
...
function initFluidEffect(oldConfig: SplashCursorProps) {
	...
	let config = {
		SIM_RESOLUTION: oldConfig.SIM_RESOLUTION!,
		DYE_RESOLUTION: oldConfig.DYE_RESOLUTION!,
		CAPTURE_RESOLUTION: oldConfig.CAPTURE_RESOLUTION!,
		DENSITY_DISSIPATION: oldConfig.DENSITY_DISSIPATION!,
		VELOCITY_DISSIPATION: oldConfig.VELOCITY_DISSIPATION!,
		PRESSURE: oldConfig.PRESSURE!,
		PRESSURE_ITERATIONS: oldConfig.PRESSURE_ITERATIONS!,
		CURL: oldConfig.CURL!,
		SPLAT_RADIUS: oldConfig.SPLAT_RADIUS!,
		SPLAT_FORCE: oldConfig.SPLAT_FORCE!,
		SHADING: oldConfig.SHADING!,
		COLOR_UPDATE_SPEED: oldConfig.COLOR_UPDATE_SPEED!,
		PAUSED: false,
		BACK_COLOR: oldConfig.BACK_COLOR!,
		TRANSPARENT: oldConfig.TRANSPARENT!,
	};
